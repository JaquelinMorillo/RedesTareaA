...
<div style="text-align: justify">
Otra de las métricas que podemos obtener es el análisis de triadas. En este sentido nuestra red cuenta con 15991 triadas de tipo A<-B->C, 195830 de tipo A->B<-C, 1507 de tipo A->B->C, 1 de tipo A<->B->C, 578 de tipo A->B<-C, A->C, 57 de tipo A<-B->C, A<->C, 17 de tipo A->B<-C, A<->C y una de tipo A<->B<->C, A<->C.
<div/>
...
```
<div style="text-align: justify">
También podemos estudiar la distancia media de la red, que, en este casdo es de 1,357. 
<div/>
